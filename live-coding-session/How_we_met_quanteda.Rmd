...
![**Source: our amazing classmates from the MDS 2023: Laura Menicacci & Dinah Rabe**](images/magicworkflow.png){fig-align="center" height="300"}
...
```{r libraries, eval = TRUE,  class.source = "fold-show"}
...
```{r 07, eval = TRUE, class.source = "fold-show"}
...
Now let's do a rate to check in which episodes it can be more a negative context. We will use `[Scaling Policy Preferences from Coded Political Texts from WILL LOWE, KENNETH BENOIT, SLAVA MIKHAYLOV, MICHAEL LAVER (2010)](https://kenbenoit.net/pdfs/Loweetal_2010_LSQ.pdf).
...
-   [Text mining with R](https://www.networkx.nl/blog/text-mining-r-vikings/){target="_blank"}

-   [Content analysis with R](https://content-analysis-with-r.com/2-metrics.html){target="_blank"}

-   [Tutorial 4: Key term extraction](https://tm4ss.github.io/docs/Tutorial_4_Term_extraction.html){target="_blank"}
